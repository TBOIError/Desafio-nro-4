            ...
            if (validarcampo)
            {
                ...
                if (validarcampo)
                {
                    if (comboBoxAÑOS.SelectedIndex > -1)
                    {
                        ...
                        if (comboBoxAÑOS.SelectedIndex == 2)
                        {
                            años = 15;
                        }
            ...
            if (validarcampo) {
                ...
                if (validarcampo)
                {
                    if (comboBoxPISO.SelectedIndex > -1)
                    {
                        ...
                        if (comboBoxPISO.SelectedIndex == 2)
                        {
                            nropiso = 4;
                        }
                        ...
                        {
                            MessageBox.Show("Debe seleccionar una opcion de AÑOS DE ANTIGUEDAD, por favor corrija.", "ERROR");
                        }
                    }
                    else
                    {
